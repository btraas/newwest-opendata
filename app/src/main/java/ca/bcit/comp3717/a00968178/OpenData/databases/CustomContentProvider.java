...
import ca.bcit.comp3717.a00968178.OpenData.CategoriesOpenHelper;
import ca.bcit.comp3717.a00968178.OpenData.DatasetsOpenHelper;
    ...
    extends ContentProvider
{
    ...
    static
    {
        ...
        for(int i = 0; i < TABLES.length; i++) {
            uriMatcher.addURI("ca.bcit.comp3717.a00968178.OpenData", TABLES[i], i);
        }
    }
