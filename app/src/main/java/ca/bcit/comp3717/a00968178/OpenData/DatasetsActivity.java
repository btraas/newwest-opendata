...
public class DatasetsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void init()
    {
        ...
        adapter = new SimpleCursorAdapter(getBaseContext(),
                ...
                null, // openHelper.getRows(getApplicationContext(), "category_id = ?", new String[] {""+this.categoryId}),
                new String[]
                        {
        ...
        manager.initLoader(0, null,
                new CustomLoaderCallbacks(DatasetsActivity.this, adapter,
                        openHelper.getContentUri(),
                        null,
                        "category_id = ?",
                        new String[] {""+this.categoryId},
                        null
                ));
